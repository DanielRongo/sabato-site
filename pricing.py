...
COPY["it"] = dict(
    ...
    t_cols=[
        ...
        dict(h="Call center in outsourcing", acc=False,
             bars=[(56, "lavoro diretto, minimo di legge", "clay"),
    ...
    f_items=[
        ...
        ("Come si confronta con un call center in outsourcing?",
         "In Italia il costo del lavoro di un minuto di call center lo fissa un decreto del Ministero del Lavoro: le tabelle lo mettono tra 0,33 e 0,50 euro al minuto, e sono solo retribuzioni dirette, senza formazione, supervisori né costi di struttura. Un operatore rende poi circa 44 minuti utili per ogni ora pagata, quindi un minuto reale in outsourcing sta tra 0,70 e 1,00 euro. Sabato costa 0,55 euro tutto compreso, risponde a tutte le chiamate insieme e non fattura nulla quando la linea è ferma."),
